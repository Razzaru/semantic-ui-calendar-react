...
define(["require", "exports", "react", "./BaseCalendarView", "./Calendar", "./CalendarBody/Body", "./CalendarHeader/Header", "./CalendarFooter/Footer", "../lib"], function (require, exports, React, BaseCalendarView_1, Calendar_1, Body_1, Header_1, Footer_1, lib_1) {
    "use strict";
    ...
    var DayView = /** @class */ (function (_super) {
        ...
        DayView.prototype.render = function () {
            ...
            return (React.createElement(Calendar_1.default, __assign({ ref: function (e) { return _this.calendarNode = lib_1.findHTMLElement(e); }, outlineOnFocus: inline }, rest),
                ...
                showFooter && (React.createElement(Footer_1.default, { onCellClick: onValueClick, setDate: setDate }))));
        };
        return DayView;
