...
var FooterCell = function (_a) {
    ...
    return (React.createElement(Table.Cell, { onMouseEnter: function () { return setHovered(true); }, onMouseLeave: function () { return setHovered(false); }, onClick: function (event) {
